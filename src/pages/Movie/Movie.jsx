            ...
            style={{
              backgroundImage: `url("${
                slides[currentIndex] && slides[currentIndex].image
                  ...
                  : "https://imgs.search.brave.com/Up5OWJDsaXV9kx91YCA1K4hIg1C-I3nIlHl_6DiXM_k/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9tZWRpYS5nZXR0eWltYWdlcy5jb20vaWQvMTEzMjc5MTk2Mi9waG90/by9oYXBweS1hdC10/aGUtbW92aWVzLmpw/Zz9zPTYxMng2MTIm/dz0wJms9MjAmYz1i/cU5RcnpQelhDV3p3/TkUwSDIyUU14dkxU/c1VJb0NVRWRUWWdF/U0JmYjZFPQ"
              }")`,
            }}
          >
            <span
              ...
              <div className="px-6">
                ...
                <div className="text-center mt-12">
                  ...
                  <div className="mb-2">
                    ...
                    >
                      {buttonLoading ? (
                        <div className="loader border-t-2 rounded-full border-gray-500 bg-white animate-spin aspect-square w-8 flex justify-center items-center text-yellow-700"></div>
                      ) : isInAboutTo ? (
