    ...
    <div className="bg-transparent flex justify-between items-center h-20 overflow-hidden">
      <form className="w-[75%]" onSubmit={handleSearch}>
        ...
        <div className="relative">
          ...
          <button
            type="submit"
            className="text-white hidden absolute end-2.5 bottom-2.5 bg-[#e0324b] hover:bg-[#4c2a36] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2"
          >
            Search
          </button>
        </div>
